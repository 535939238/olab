...
var p = "svg" === document.documentElement.tagName.toLowerCase();
var q = p ? o : m() ? function () {
  function a() {
...
const QRCode = function (a, b) {
  ...
  "string" == typeof a && (a = document.getElementById(a)), this._el = a, this._oQRCode = null, this._oDrawing = new q(this._el, this._htOption), this._htOption.text && this.makeCode(this._htOption.text)
};
...
QRCode.prototype.makeImage = function () {
  "function" == typeof this._oDrawing.makeImage && (!_android || _android >= 3) && this._oDrawing.makeImage()
};
